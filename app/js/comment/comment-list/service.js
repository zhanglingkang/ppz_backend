...
define(function (require, exports, module) {
    ...
    app.service("commentListService", ["httpService", function (httpService) {
        return {
            /**
             * @param data 查询参数
             * @param success
             * @param error
             */
            getCommentList: function (data, success, error) {
                httpService.get({
                    r: "special/index",
                    data: data,
            ...
            importComment: function (data, success, error) {
                httpService.get({
                    r: "special/import",
                    data: data,
                    success: function (data, headers) {
            ...
            sortComment: function (data, success, error) {
                httpService.get({
                    r: "special/updatePosition",
                    data: data,
                    success: function (data, headers) {
            ...
            deleteComment: function (id, success, error) {
                var data = {
                    id: id
                };
                httpService.get({
