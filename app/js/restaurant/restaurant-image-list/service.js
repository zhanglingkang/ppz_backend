...
define(function (require, exports, module) {
    ...
    app.service("restaurantImageListService", ["httpService", function (httpService) {
        return {
            /**
             * @param data 查询参数
             * @param success
             * @param error
             */
            getRestaurantImageList: function (data, success, error) {
                httpService.get({
                    r: "special/index",
                    data: data,
            ...
            importRestaurantImage: function (data, success, error) {
                httpService.get({
                    r: "special/import",
                    data: data,
                    success: function (data, headers) {
            ...
            sortRestaurantImage: function (data, success, error) {
                httpService.get({
                    r: "special/updatePosition",
                    data: data,
                    success: function (data, headers) {
            ...
            deleteRestaurantImage: function (id, success, error) {
                var data = {
                    id: id
                };
                httpService.get({
