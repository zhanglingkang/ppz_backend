...
define(function (require, exports, module) {
    ...
    app.service("menuListService", ["httpService", function (httpService) {
        return {
            /**
             * @param data 查询参数
             * @param success
             * @param error
             */
            getMenuList: function (data, success, error) {
                httpService.get({
                    r: "special/index",
                    data: data,
            ...
            importMenu: function (data, success, error) {
                httpService.get({
                    r: "special/import",
                    data: data,
                    success: function (data, headers) {
            ...
            sortMenu: function (data, success, error) {
                httpService.get({
                    r: "special/updatePosition",
                    data: data,
                    success: function (data, headers) {
            ...
            deleteMenu: function (id, success, error) {
                var data = {
                    id: id
                };
                httpService.get({
